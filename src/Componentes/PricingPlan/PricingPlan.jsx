    ...
    return (
        ...
        <div className="container mx-auto p-4 sm:p-10">
            <div className="mb-16 space-y-4 text-center">
                ...
                <p className="px-4 sm:px-8 lg:px-24">Patients and their family member can enjoy privileges for becoming <br></br>a member of Zara health club with a reasonable fee.</p>
                <div>
                    <button className="px-4 py-1 font-semibold  rounded-l-lg bg-custom border border-white text-white">Monthly</button>
                ...
                <div className="relative z-0 flex flex-col items-center p-8 border rounded-md bg-gray-800">
                    ...
                    <ul className="flex-1 space-y-2">
                        <li className="flex items-center space-x-2">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-6 h-6 active">
